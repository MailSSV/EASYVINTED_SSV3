      ...
      <div className="max-w-5xl mx-auto">
        ...
        <form className="space-y-6">
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
              <h2 className="text-lg font-semibold text-gray-900 mb-4">Prix de vente</h2>
          ...
          {id && articleStatus === 'ready' && (
            <div className="relative overflow-hidden rounded-xl border border-emerald-200 bg-emerald-50/50 backdrop-blur-sm">
